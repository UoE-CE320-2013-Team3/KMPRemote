...
public class Symbolkey extends Activity {
	...
	public void KeyboardToggleA(View v) {
        ...
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.A_Toast, Toast.LENGTH_SHORT).show();
    }
    public void KeyboardToggleB(View v) {
        cmd = "KEYBOARD TOGGLE b";
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.B_Toast, Toast.LENGTH_SHORT).show();
    }
    public void KeyboardToggleC(View v) {
        cmd = "KEYBOARD TOGGLE c";
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.C_Toast, Toast.LENGTH_SHORT).show();
    }
    public void KeyboardToggleD(View v) {
        cmd = "KEYBOARD TOGGLE d";
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.D_Toast, Toast.LENGTH_SHORT).show();
    }
    public void KeyboardToggleE(View v) {
        cmd = "KEYBOARD TOGGLE e";
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.E_Toast, Toast.LENGTH_SHORT).show();
    }
    ...
    public void KeyboardToggle1(View v) {
        ...
        keyboardSend(v);
        Toast.makeText(Symbolkey.this, R.string.ONE_Toast, Toast.LENGTH_SHORT).show();
    }
